...
function About() {
  return (
    <div className="about">
      ...
      <h3>Integration with EduChain</h3>
      <p>
        SafeSend has now expanded to include <strong>EduChain</strong>, an innovative blockchain network focused on education and secure fund transfers within academic ecosystems. Through this integration, users can seamlessly send, claim, and reclaim EDU tokens on the EduChain network, ensuring safe and efficient financial transactions within the education sector. 
      </p>
      <p>
        This project is proudly supported by <strong>EduChain Microgrants</strong>, which funds initiatives aimed at enhancing blockchain adoption in educational environments.
      </p>
      ...
      <h3>Key Features</h3>
      <ul>
        <li><strong>Send Crypto:</strong> Learn how to send tokens to any wallet address on the Linea Network and EduChain. We guide you through every step, ensuring that you understand the importance of using the correct network and double-checking addresses.</li>
      ...
      <p>
        SafeSend includes a unique "Learn Mode" designed to educate users about blockchain and cryptocurrency transactions. When Learn Mode is enabled, additional tutorials and guidance appear for each function. You’ll learn about:
      </p>
      <ul>
      ...
      <p>Twitter/X: <a href="https://x.com/SafeSendDapp" target="_blank" rel="noopener noreferrer">https://x.com/SafeSendDapp</a></p>
    </div>
  );
}
